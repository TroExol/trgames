...
const AlertDialogHeader = observer(({
  className,
  ...props
...
const AlertDialogFooter = observer(({
  className,
  ...props
}: React.HTMLAttributes<HTMLDivElement>) => (
  <div
